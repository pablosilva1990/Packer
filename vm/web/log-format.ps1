...
& $AppCmd set config -section:system.applicationHost/sites /+"siteDefaults.loFile.customFields.[logFieldName='X-Forwarded-For',sourceName='X-Forwarded-For',sourceType='RequestHeader']" /commit:apphost
